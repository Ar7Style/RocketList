...
#define USER_CACHE [[NSUserDefaults standardUserDefaults] initWithSuiteName:@"group.rocketlist.ru"]
...
-(void) loadData
{
    ...
    _todoList = [NSMutableArray arrayWithArray:[[[NSUserDefaults standardUserDefaults] initWithSuiteName:@"group.rocketlist.ru"] valueForKey:@"todoListFromServer"]];
    [self.tableView reloadData];
}
...
{
    NSMutableArray* temp = [USER_CACHE valueForKey:@"todoListFromServer"];
    return temp.count;
}
